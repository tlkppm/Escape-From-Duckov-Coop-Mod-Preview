...
namespace EscapeFromDuckovCoopMod
{
    ...
    {
        private static readonly Dictionary<Inventory, bool> _world = new Dictionary<Inventory, bool>();
    ...
    public class LootManager : MonoBehaviour
    {
        ...
        public readonly Dictionary<uint, (Inventory inv, int pos)> _cliPendingReorder
            = new Dictionary<uint, (Inventory inv, int pos)>();

        // token -> 目的地
        public readonly Dictionary<uint, PendingTakeDest> _cliPendingTake
            = new Dictionary<uint, PendingTakeDest>();
        ...
        public readonly Dictionary<Inventory, float> _srvLootMuteUntil
            = new Dictionary<Inventory, float>(new RefEq<Inventory>());
